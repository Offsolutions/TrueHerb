...
public partial class Test : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                objsql.ExecuteNonQuery("insert into tblcapping(regno,date,todayleft,todayright,leftleg,rightleg,todaycapping) values('" + dd["regno"] + "','" + System.DateTime.Now + "','0','0','" + dd["leftleg"] + "','" + dd["rightleg"] + "','0')");
            }
        }
